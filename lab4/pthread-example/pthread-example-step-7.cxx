...
int main(int argc, char** argv)
{
    ...
    double time_taken = chrono::duration<double>(end - start).count() * 1e-9;
...
void* initialisation_callback(void* aThreadData)
{
    ...
    {
        (*(p_thread_data->a))[i] = uniform_distribution(generator);
        (*(p_thread_data->b))[i] = uniform_distribution(generator);
    }
